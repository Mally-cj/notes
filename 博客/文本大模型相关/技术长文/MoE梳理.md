...
![](./_assets/RdvublI7io0ZR1xO3FPc0HtynJg.png)

### MoE 的具体过程是怎么样的？

![](./_assets/ARjbbZpeRoqUK1xNd3FcM2TUnv6.png)
...
![](./_assets/WSe7bkFy8omJJtxGEwScffCVnKb.png)
...
![](./_assets/R1YwbBHvtose7FxSPvUcRmtanJc.png)
...
![](./_assets/OBRbbR14coPTp2xnpsOc6EeinR5.png)
![](./_assets/WFwlbOrHWo7IsmxTPAWcchj9n6e.png)

#### 实验：

##### 实验 1:验证本文模型效果好

![](./_assets/BwcXbpuMEoW1lyxAQidc6E7tnKc.png)
**模型配置**：
...
- 每个 token 都会通过一个固定住的专家（右图中的黄色 MLP，本文是 Top-1 的方式）和一个选择的专家（Top-1），这种模型叫做 Residual-MoE，每一层的表达式为：$y = \mathrm{MLP}^{(l)}(x) + g \cdot Expert^{(l)}(x) $
  ![](./_assets/Qn1xbPcG6o71tcx4Q19cWf7pn6e.png)

#### 实验：

##### 实验 1:验证更深层的 MoE 需要更多专家

![](./_assets/S8EJbFbjqoKuVQxL5OOc3IDDnHb.png)
**实验设置：**
...
![](./_assets/XxBlb0EfwoLwH6xRt55cfDPxnBv.png)
**实验设置：**
...
![](./_assets/UD5XbzIaIoHTgEx5eDPcO7q0nCd.png)
![](./_assets/TAUdbZH0hoeQKIx0l9GcEI7VnJb.png)
...
![](./_assets/Atmtb35flo1hD4xuFKscsjwHnOf.png)
![](./_assets/JAICbpaBGowOUSxHYc4cqQFlnCg.png)

![](./_assets/XXSSbBJBso7qNUx5t94cXOENnkh.png)

### DeepSeek-MoE( deepseek v2)

#### **解决问题**：

![](./_assets/SVcebVKx5owd2RxxR0kcApgsnFc.png)

#### 具体细节：

1. **细粒度专家分割方法：**以往方法是 N 个专家里选择 k 个，而这个方法是把每个专家划分成更小 m 个更小的专家，然后从 mN 个专家里选择 mk 个。
   ![](./_assets/Pm2wbkvmKo0mMgxmyNgcJtL0nVh.png)
2. **共享专家隔离方法：**除了细粒度专家分割策略外，隔离了  $K_s$个专家作为共享专家，总是保持激活，同时细粒度专家的激活数也变为了  $mN-K_s$
   ![](./_assets/UgbkbP1gToeLnExhSBTcOLBWnSf.png)

#### 实验：验证提出的细粒度分割，以及共享隔离方案的有效性

![](./_assets/DwwYbeExiomcqBxsO19cesbDnSg.png)
...
![](./_assets/WRlZbyGqdoDDumxv41qcNrDsn5m.png)
![](./_assets/HABqbw8GYoahISxfJlQc4ME6n6b.png)

#### 实验：验证 Gating Logit Normalization 方法效果

![](./_assets/RdpDbaMxooeAYvxkQX5c61icn0c.png)
![](./_assets/SFmqbHwuVotlkxxToEQcKNnInNd.png)

![](./_assets/OZkwbSYKAouP8sx34DtcrFpKnWc.png)
...
![](./_assets/WTUcbc4AMonI0Gx6OD6cAVlpneb.png)

![](./_assets/CnY3bRff7oICMOxeCRZcMhstn23.png)

> 如何判断专家过载，文章好像说是根据定期检测的统计数据得到的。
> ![](./_assets/FMKqbIA4SoIksHxNzzIcDBiQnKf.png)

#### 实验： 验证无辅助损失策略可以提升专家专业化

![](./_assets/GyZvbGYzUojs8DxWyBKcFq0Ynbd.png)
**实验设置：**
...
![](./_assets/GSzLbPukcoEDELxcPrCc43T6nsx.png)
...
![](./_assets/HNCTbsUJOoxqt1xOCxRcvKetnCh.png)

#### 实验：验证方法起作用

![](./_assets/LRpZb1KM9oyXeVxfkZkcuwGsnNg.png)
**图例说明：**
...
![](./_assets/Zx3ObbNmRoq9CWxYlRPctKlXnse.png)

### 基于全局批次的辅助损失 （qwen3 中使用）

#### 解决问题；

![](./_assets/KXrybIQb8oXA7Vxcy3FcHLRqn5f.png)

#### 具体细节：

![](./_assets/SpDvb3RS6oOkC8xDtAKcmYkEnaf.png)
...
![](./_assets/SfwGbiAswoWdK4xB5SacCRbDnFh.png)

#### **具体方案：**

![](./_assets/ThBpbj1yOoMKC9xuZudcGm2HnSI.png)

![](./_assets/E6TPbjcRGooAHHxtYZ6clk7bn7d.png)

![](./_assets/URKobjiXDoLsYIxP5xvc5OxJn0e.png)
...
![](./_assets/NgYybjQXBowJHOx89wmceNgOnSb.png)
...
![](./_assets/YGQnbMXqQolZLixNCDGcbTRyn7d.png)
**图例说明：**
...
![](./_assets/OoxKbAHbto0yXbxN00YcFvQSnTe.png)

### 其他文章

![](./_assets/RLfxb2bxxoXw0PxMry8cWBZonJd.png)
